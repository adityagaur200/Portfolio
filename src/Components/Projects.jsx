      ...
      <div className='projects'>
        ...
        <section className="cards">
          ...
          <article className="card card--2">
            <div className="card__img"></div>
            <a href="https://github.com/adityagaur200/CloShop" className="card_link">
              <div className="card__img--hover"></div>
            </a>
            <div className="card__info">
              ...
              <span className="card__by">
                ...
                <a href="https://github.com/adityagaur200/CloShop"></a>
              </span>
            </div>
          </article>
          ...
          <article className="card card--4">
            <div className="card__img"></div>
            <a href="https://github.com/adityagaur200/news_app" className="card_link">
              <div className="card__img--hover"></div>
            </a>
            <div className="card__info">
              <h3 className="card__title">NEWS APP</h3>
              <span className="card__by">
                Developed in React. Allows reading news.
                <a href="https://github.com/adityagaur200/news_app"></a>
              </span>
            </div>
          </article>
        </section>
        ...
        <div className='stackdiv'>
          <Stack direction={"row"} gap={2} mt={6}>
            ...
            <a href='https://linkedin.com/in/adityagaur2'> <CiLinkedin size={"30px"} /></a>
